...
const Contact = () => {
    ...
    const onSubmit = async (event) => {
      ...
      formData.append("access_key", "67367831-2682-4d45-8796-681f62e4ab0c");
        ...
        id='contact' className='w-full px-[12%] py-10 scroll-mt-20 bg-[url("/footer-bg-color.png")] bg-no-repeat bg-center bg-[length:90%_auto] dark:bg-none'>
            ...
            className='text-center mb-2 text-lg font-Ovo'>connect with me</motion.h4>
             ...
             className='text-center max-w-2xl mx-auto mt-5 mb-12 font-Ovo '>
                I'd love to hear from you! If you have any questions, comments, or feedback, please fill the form below.</motion.p>
            ...
            onSubmit={onSubmit} className='max-w-2xl mx-auto'>
                ...
                name='message' id="" rows='6' placeholder='Enter your Message' required className='w-full p-4 outline-none border-[0.5px] border-e-gray-400 rounded-md bg-white mb-6 dark:bg-darkHover/30 dark:border-white/90'></motion.textarea>
