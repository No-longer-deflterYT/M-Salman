...
const Navber = ({isDarkMode, setIsDarkMode}) => {
    ...
    return (
        ...
        <div className='fixed top-0 right-0 w-11/12 -z-10 translate-y-[-80%] dark:hidden'>
            ...
            <nav className={`w-full fixed px-5 lg:px-8 xl:px-[8%] py-4 flex items-center justify-between z-50 ${isScroll ? "bg-white bg-opacity-50 backdrop-blur-lg shadow-sm dark:bg-darkTheme dark:shadow-white/20" : ""}`}>
                ...
                contact<Image alt='' src={isDarkMode ? assets.arrow_icon_dark : assets.arrow_icon} className='w-3'/></a>
                <button className='block md:hidden ml-3' onClick={openMeun}>
                ...
                <div className='absolute right-6 top-6' onClick={closeMeun}>
                    <Image src={isDarkMode ? assets.close_white : assets.close_black} alt='' className='w-5 cursor-pointer'/>
                </div>
                <li><a className='font-Ovo' href="#top">Home</a></li>
                    <li><a className='font-Ovo' onClick={closeMeun} href="#about">About me</a></li>
                    <li><a className='font-Ovo' onClick={closeMeun} href="#services">Services</a></li>
                    <li><a className='font-Ovo' onClick={closeMeun} href="#work">My Work</a></li>
                    <li><a className='font-Ovo' onClick={closeMeun} href="#contact">Contact me</a></li>
                </ul>
            </nav>
        </>
    );
